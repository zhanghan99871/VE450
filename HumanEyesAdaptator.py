...
class HumanEyesAdaptator:
    ...
    def fit(self):
        ...
        for i, y_file in enumerate(self.Y_files):
            ...
            # TODO: change initial guesses and bounds for parameters
    ...
    def visualize_fit(self, k_values, b_values, c_values, r2_scores, delta_Es, output_file, r2_avg):
        ...
        plt.title('R^2 Scores for Each Adjusted Image')
    ...
    def save_comparison_images(self, output_dir, k_values, b_values, c_values, sample_luminance_values, r2_scores, delta_Es):
        ...
        for i, (y_file, luminance_value, r2_score_val, delta_E_val) in enumerate(zip(self.Y_files, sample_luminance_values, r2_scores, delta_Es)):
            try:
                ...
                # TODO: Not sure. Normalize adjusted luminance to 0-255 range
...
def fit_on_all_data_sets(data_sets, fit_func, output_base_dir):
    ...
    for data_set in data_sets:
        ...
        output_dir = os.path.join(output_base_dir, f'comparison_gamma_{os.path.basename(os.path.dirname(initial_png_file))}')
...
# plot the relationship between mean values of k, b, and c and initial luminance
...
# Linear fit params with luminance for low luminance data sets
...
# apply the generalized model (linear for now) and visualize the results
...
output_base_dir = os.path.join(current_path, 'comparisons_gamma')
...
data_sets_high_luminance = [
    ...
    (os.path.join(current_path, 'data/VW310/VW310-6CS.DRL-20220328.HV_2654.74.png'),
     [
         os.path.join(current_path, 'data/VW310/VW310-6CS.DRL-20220328.HV_00{}.png'.format(i+1)) for i in range(20)
     ],
    ...
    (os.path.join(current_path, 'data/VW310-PL/VW310-6CS.PL-FTSL-20220401.HV_1744.43.png'),
     [
         os.path.join(current_path, 'data/VW310-PL/VW310-6CS.PL-FTSL-20220401.HV_00{}.png'.format(i+1)) for i in range(20)
     ],
    ...
    (os.path.join(current_path, 'data/VW316/VW316 7CS.RTSL-BUL-SL-TL.HV_2124.45.png'),
     [
         os.path.join(current_path, 'data/VW316/VW316 7CS.RTSL-BUL-SL-TL.HV_00{}.png'.format(i+1)) for i in range(20)
     ],
    ...
    (os.path.join(current_path, 'data/VW323/VW323 0CS.SL-RTSL-BUL-RFL.HV_2381.67.png'),
     [
         os.path.join(current_path, 'data/VW323/VW323 0CS.SL-RTSL-BUL-RFL.HV_00{}.png'.format(i+1)) for i in range(20)
     ],
    ...
    (os.path.join(current_path, 'data/VW331/VW331_Basic_CHL_simulation setting.DRL_PL_FTSL_20220311.HV_15241.2.png'),
     [
         os.path.join(current_path, 'data/VW331/VW331_Basic_CHL_simulation setting.DRL_PL_FTSL_20220311.HV_00{}.png'.format(i+1)) for i in range(20)
     ],
